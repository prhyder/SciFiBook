...
<head>
	...
	<style>
		...
		#hero {
				background-image: 
				url("<?php echo get_template_directory_uri(); ?>/images/Hero-Explorer-Blue.jpg");
				background-size: cover;
				object-fit: contain;
				background-position: 50% 75%;
...
<div id="page" class="site">
	...
	<!-- Top Section -->
<section id="top-header" class="d-flex flex-column justify-content-center align-middle align-center text-center mx-auto" style="display:none;">
