		...
		<div class="container">
			<div class="row">
				...
				<div class=" text-center white border-bottom pb-5">
					<p class="follow pb-1">Follow Author John Stephens</p>

					<div class="justify-content-center text-center">
						<a class="stk-link stk-button stk--hover-effect-darken" href="" rel="noreferrer noopener">
						
						<button aria-label="Facebook" type="button" class="btn btn-secondary btn-sm mx-2">
						...
						<a href="" rel="noreferrer noopener">
							<button aria-label="Twitter" type="button" class="btn btn-secondary btn-sm mx-2">
								<span class="ct-icon-container">
									<svg width="20px" height="20px" viewBox="0 0 20 20" aria-hidden="true">
						...
						<a href="" rel="noreferrer noopener">
							<button aria-label="Pinterest" type="button" class="btn btn-secondary btn-sm mx-2">
								<span class="ct-icon-container">
									<svg width="20px" height="20px" viewBox="0 0 20 20" aria-hidden="true">
						...
						<a href="" rel="noreferrer noopener">
							<button aria-label="LinkedIn" type="button" class="btn btn-secondary btn-sm mx-2">
								<span class="ct-icon-container">
									<svg width="20px" height="20px" viewBox="0 0 20 20" aria-hidden="true">
						...
						<a href="" rel="noreferrer noopener">
							<button aria-label="Email" type="button" class="btn btn-secondary btn-sm mx-2">
								<span class="ct-icon-container">
				...
				<p class="text-center white pt-3">
					<span class="footer-text-item">© 2024 John Stephens</span>
