			...
			<div class="carousel-inner">
					...
					<div class="container d-flex text-center pt-5 pb-5">
						<div class="row pt-5 pb-5">
							<div class="col reviews-col d-flex flex-column mx-auto">
								...
								<p>I couldn't put this down. The Omega Project is an electrifying journey that left me on the edge of my seat from start to finish.</p>
				...
				<div class="carousel-item" style="height:400px;">
					<div class="container d-flex text-center pt-5 pb-5">
						<div class="row pt-5 pb-5">
							<div class="col reviews-col d-flex flex-column mx-auto">
								<h3>A thrilling sci-fi action read.</h3>
								<p>John Stephens has crafted a masterful blend of science fiction and adventure that kept me guessing until the very end. The worldbuilding is impressive, and the plot kept me hooked.</p>
		...
		<div class="container pt-5 pb-5 white align-items-center">
			<div class="row pt-5 pb-5 align-items-center">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 details" >
					...
					<p>Earth is threatened by the arrival of a hostile alien force.  In the year 2150, humanity finds itself on the brink of extinction as a relentless alien armada descends upon the planet. The fate of humanity rests on the shoulders of a few brave souls.</p>
					<p>Among them is Captain Alex Mercer, a seasoned space pilot with a troubled past. Leading a small crew aboard the starship the <i>Galactic Horizon,</i> Mercer embarks on a desperate mission to uncover the secrets of the alien invaders and find a way to save Earth.</p>
					<div class="pt-5">
		...
		<div class="container pt-5 pb-5">
			<div class="row pt-5 pb-5">
				...
				<div class="col-md-12 col-lg-8 gx-5">
					...
					<p class="author-description">John Stephens is a visonary author who blends the realms of science with the thought-provoking exploration of humanity's place in the cosmos. 
						His love for writing began as a high school student and has only accelerated from there. John's stories are characterized by their vivid imagery and intricate worldbuilding.</p>
						<p class="author-description">When he isn't writing his latest adventure, he can be found hiking the forests of western Oregon where he calls home.</p>
				</div>
			</div>
		</div>
	</section>
